...
const CHANGELOG_ENTRIES = [
  { v: 'v1.8.1', date: '2026-06-11', body: "Under-the-hood tidy-up: the game is now split into three files — tower-defense.html (markup), tower-defense.css (styles) and tower-defense.js (code) — instead of one giant HTML file. Nothing changes for you: just double-click tower-defense.html to play, exactly as before. This makes the codebase easier to maintain going forward." },
