...
## Table-stakes (polished-browser-game basics — re-audited v1.24.2 + v1.27.1 + v1.37.1 + v1.40.1 + v1.45.1 + v1.50.1 + v1.55.1 + v1.60.1 + v1.65.1 + v1.74.1 + v1.79.1 + v1.84.1 health checks)
...
- [ ] **Split the test harness file** (noted v1.24.2, re-confirmed v1.27.1 + v1.32.1 + v1.37.1 + v1.40.1 + v1.45.1 + v1.50.1 + v1.55.1 + v1.60.1 + v1.65.1 + v1.70.1 + v1.74.1 + v1.79.1 + v1.84.1 health checks) —
      `tests/run-tests.mjs` has grown to **~6,176 lines (92 groups `[1]`–`[92]`, 986 assertions)** in a
