...
## Table-stakes (polished-browser-game basics — re-audited v1.24.2 + v1.27.1 + v1.37.1 + v1.40.1 + v1.45.1 + v1.50.1 + v1.55.1 + v1.60.1 + v1.65.1 + v1.74.1 + v1.79.1 + v1.84.1 + v1.89.1 health checks)
...
- [x] **GitHub Actions CI** — shipped **v1.71.1**. `.github/workflows/ci.yml` runs the
      ...
      concurrency group; never stages or modifies a game file (drives the real
...
- [ ] **Split the test harness file** (noted v1.24.2, re-confirmed v1.27.1 + v1.32.1 + v1.37.1 + v1.40.1 + v1.45.1 + v1.50.1 + v1.55.1 + v1.60.1 + v1.65.1 + v1.70.1 + v1.74.1 + v1.79.1 + v1.84.1 + v1.89.1 health checks) —
      `tests/run-tests.mjs` has grown to **~6,581 lines (97 groups `[1]`–`[97]`, 1045 assertions)** in a
